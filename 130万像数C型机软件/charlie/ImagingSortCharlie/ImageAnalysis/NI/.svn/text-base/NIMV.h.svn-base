...
//   IMAQ_FIND_REFERENCE                 = 0,           //The location and orientation of the object set both the reference system and the measurement system of the coordinate transform.
//   IMAQ_UPDATE_TRANSFORM               = 1,           //The location and orientation of the object set the new measurement system of the coordinate transform.
...
typedef struct StraightEdgeReport_struct {
  ...
  double      straightness;   //The straightness of the calculated edge, which is equal to the least-square error of the fitted line to the entire set of coordinates.
...
extern "C" {
  ...
  CircularEdgeReport* __stdcall imaqFindCircularEdge(Image* image, Annulus searchArea, SpokeDirection direction, 
    const FindEdgeOptions* options, const CoordinateTransform2* transform,
    SpokeReport** origReport
    );
